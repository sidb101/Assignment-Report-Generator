...
class htmlGenerator():
    ...
    def processHTML(self):
        ...
        pdfkit.from_string(main_html,'{}/out.pdf'.format(self.outputDirectory),configuration=config, options=self.pdf_options)
...
class MainApplication():
    ...
    def setDirOptions(self,dialogTitle):
        ...
        options['initialdir'] = 'C:\\' if os.name=='nt' else '{}'.format(os.getcwd()[:-20])
